...
data_FCD2_n,time=data_FCD2[range(0,52)]
...
segmented_frame=np.empty(shape=[52,40000])
stored_filtered_data=np.empty(shape=[52,10,40000])
seg_filtered_data=np.empty(shape=[180,52,10,40000])
...
Temp2=np.empty(shape=[52,10,9])     #channel X subbands X new_features
Temp3=np.empty(shape=[180,52,10,9])  #segments X cnannel X subbands X new_features
...
scipy.io.savemat('Pt2_sheuli_new_fea_0_180epoc_Norm.mat', mdict={'pt2_0_180epoc_sheuliNew_fea': Temp3})        
