...
EDF_NAME = '/Volumes/ExternalHDD/intracranial/FCD/20200511_tanaka/EDF/FJ8130VL.edf' 
...
data_FCD2_n,time=data_FCD2[range(0,86)]
...
chan0_15=data_FCD2_n[0:16,:]
chan18=data_FCD2_n[18:19,:]
chan20_36=data_FCD2_n[20:37,:]
chan43_44=data_FCD2_n[43:45,:]
chan47_68=data_FCD2_n[47:69,:]
chan72_79=data_FCD2_n[72:84,:]



data_FCD2_n=np.vstack((chan0_15,chan18, chan20_36,chan43_44,chan47_68,chan72_79))
...
segmented_frame=np.empty(shape=[70,20000])
stored_filtered_data=np.empty(shape=[70,7,20000])
seg_filtered_data=np.empty(shape=[180,70,7,20000])
...
Temp2=np.empty(shape=[70,7,9])     #channel X subbands X new_features
Temp3=np.empty(shape=[180,70,7,9])  #segments X cnannel X subbands X new_features
...
scipy.io.savemat('P11_sheuli_new_fea_0_180epoc.mat', mdict={'p11_sheufea': Temp3})        
