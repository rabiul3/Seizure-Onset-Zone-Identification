...
data_FCD2_n,time=data_FCD2[range(0,60)]
...
chan0_18=data_FCD2_n[0:19,:]
chan20_38=data_FCD2_n[20:39,:]
chan41_59=data_FCD2_n[41:59,:]
data_FCD2_n=np.vstack((chan0_18, chan20_38,chan41_59))
...
segmented_frame=np.empty(shape=[56,20000])
stored_filtered_data=np.empty(shape=[56,7,20000])
seg_filtered_data=np.empty(shape=[180,56,7,20000])
...
Temp2=np.empty(shape=[56,7,9])     #channel X subbands X new_features
Temp3=np.empty(shape=[180,56,7,9])  #segments X cnannel X subbands X new_features
...
scipy.io.savemat('P9_sheuli_new_fea_0_180epoc.mat', mdict={'p9_sheufea': Temp3})        
